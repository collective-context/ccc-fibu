...
STATIC	PSSTR apstrText_m[]=
  {"         ฺฤ TT.MM.JJJJ ฤฟ         ฺฤฤ HH.MM.SS ฤฤฟ",
   "  Datum: ภฤ            ฤู   Zeit: ภฤฤ          ฤฤู",NULL,
  };
...
STATIC	PSSTR apstrText_m[]=
  {"          ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ      ฺฤ TT.MM.JJJJ ฤฟ",
   "   Datum: ภฤ            ฤู      ภฤ            ฤู",
   "                                                ",
   "          ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ      ฺฤฤ HH.MM.SS ฤฤฟ",
   "   Zeit:  ภฤฤ          ฤฤู      ภฤฤ          ฤฤู",NULL,
  };
-----------------------------------------------------------------------
*/
