// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 12:27:24 - Wed

/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  Programme-Name: FIbasis.C	     Revision: 1.3	   (C) 1989/1991    บ
  บ    Overlay for                                                          บ
...
if(wTmp)
  ...
  if(wSelect!= -1)				    /* != ESC		    */
	...
	str("Die Klassen-Nr: ฏK%dฎ ist im Kontenplan nicht angelegt!",wSelect),
...
if( (Maske(_MSK,"FI130","LKF130",_N) && 	     // Erfassen Sachkonten
  ...
  i_Match(".KONTONR", strKey);			     // Match-Field u. -Text
      ...
      // Wi_TestPrintf(pWkbInfo_g,"\nฏ%s-%s-%sฎ.",apstrKto[0],apstrKto[1],apstrKto[9]);
