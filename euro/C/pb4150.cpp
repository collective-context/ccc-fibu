...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  Programm-Name: PB4150						    บ
  บ  Funktion	  : euroSOFT Prfbau / Asphalt Grafik			    บ
  บ                                                                         บ
  บ  Datum        :                            Update:                      บ
  บ  Author       :                            Author:                      บ
...
MGLOBAL SWORD	i_ZeichneGrafik (VOID);
MGLOBAL SWORD	i_ZeichneRaster (VOID);
MGLOBAL SWORD	i_ZeichneLinien (SWORD [], BOOL, SWORD );
MGLOBAL SWORD	i_ZeichneKreise (SWORD [], SWORD [], BOOL[]);
MGLOBAL SWORD	i_WriteFuller (SWORD , SWORD , SWORD );
MGLOBAL SWORD	i_Plot (SWORD	, SWORD   );
MGLOBAL SWORD	i_Line (SWORD , SWORD , SWORD , SWORD );
MGLOBAL SWORD	i_LiesAktDaten (SWORD []);
MGLOBAL SWORD	i_LiesGutDaten (SWORD [], SWORD [], SWORD [], BOOL[]);
...
/* HP-LJ+ kompatible Grafikbefehle */

#define GRAPH_300       fprintf(pfDevice_m,"\x1b*t300R")
#define POSX_TXT(x)     fprintf(pfDevice_m,"\x1b&a%dC",x)
#define POSY_TXT(y)     fprintf(pfDevice_m,"\x1b&a%dR",y)
#define POSX_DOT(x)     fprintf(pfDevice_m,"\x1b*p%dX",x)
#define POSY_DOT(y)     fprintf(pfDevice_m,"\x1b*p%dY",y)
#define RULEX_DOT(x)    fprintf(pfDevice_m,"\x1b*c%dA",x)
#define RULEY_DOT(y)    fprintf(pfDevice_m,"\x1b*c%dB",y)
#define PRINT_RULE      fprintf(pfDevice_m,"\x1b*c0P")
#define START_GRAFIK    fprintf(pfDevice_m,"\x1b*r1A")
#define END_GRAFIK	fprintf(pfDevice_m,"\x1b*rB")
...
#define X_MM_EH 10
#define Y_MM_EH 12
#define EH_X    (X_MM_EH*10)
#define EH_Y    (Y_MM_EH*10)
#define X_LEN   (EH_X*17)
#define Y_LEN   (EH_Y*10)
#define SPITZ_X 15
#define SPITZ_Y 15
#define ALPHA_X 25
#define ALPHA_Y 30
...
/* Plot-Variablen zur internen Verwendung */

SWORD	 swGrHoehe_m, swGrBreite_m;
SWORD	wGrInit_m;
...
switch (wSteuerKennzeichen_m)
  ...
  case 30:                                           /* PB-Protokolle        */
    ...
    awMasks_m[2] = 154; 			     /* Dummy Maske zum Druck*/
    awMasks_m[3] = 180; 			     /* Dummy Maske zum Druck*/
    awMasks_m[4] = 36;				     /* Dummy Maske zum Druck*/
    awMasks_m[5] = NULL;
    switch (wDruckKennzeichen_m)
        {
        case 30:
	  strcpy (strAppDru_m, "PB");		     /* Formular fr Asphalt-*/
          wFormular_m = 1520;                        /* Grafik               */
          break;
...
if (wRetCode && (boStrCmp(strMask_m[0], "PB4155")))  /* Asphalt Prfprotokoll*/
  {                                                  /* und Messprotokoll    */
...
if (boStrCmp(strMask_m[0],"PB4155"))		     /* Asphalt Prfprotokoll*/
  {
...
if (boStrCmp(strMask_m[0], "PB4150") || 	     /* Asph. Messprotokoll  */
    boStrCmp(strMask_m[0], "PB4155"))		     /* Asph. Messprotokoll  */
  {                                                  /* und Prfprotokoll    */
...
if (boStrCmp(strMask_m[0], "PB4150") ||              /* Asphalt Messprotokoll*/
    boStrCmp(strMask_m[0], "PB4155") || 	     /* Beton Prfprotokoll  */
...
if (boStrCmp(strMask_m[0], "PB4150") ||              /* Asphalt Messprotokoll*/
    boStrCmp(strMask_m[0], "PB4155") || 	     /* Asphalt Messprotokoll*/
    boStrCmp(strMask_m[0], "PB4160"))                /* Beton Prfprotokoll  */
  {
...
if (boStrCmp(strMask_m[0], "PB4130") ||              /*                      */
    boStrCmp(strMask_m[0], "PB4155"))		     /* Asphalt-Prfungen    */
...
while(wEnd < 0)                                      /* wenn rec < key bis   */
  ...
  if (boStrCmp(strMask_m[0],"PB4155") &&	     /* Asphalt Messprotokoll*/
      wFormular_m == 1520)
    i_ZeichneGrafik ();
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_ZeichneRaster (VOID)
{
SWORD  wZeile, wSpalte;
PSSTR  apstrSieb[20];
...
POSX_DOT(X_BAS - FETT/2);           /* Rahmen */
POSY_DOT(Y_BAS - FETT/2);
RULEX_DOT(X_LEN + FETT);
RULEY_DOT(FETT);
PRINT_RULE;
...
POSY_DOT(Y_BAS - FETT/2);
RULEX_DOT(FETT);
RULEY_DOT(Y_LEN + FETT);
PRINT_RULE;

POSX_DOT(X_BAS - FETT/2);           /* Rahmen */
POSY_DOT(Y_BAS + Y_LEN - FETT/2);
RULEX_DOT(X_LEN + FETT);
RULEY_DOT(FETT);
PRINT_RULE;

POSX_DOT(X_BAS + X_LEN - FETT/2);   /* Rahmen */
POSY_DOT(Y_BAS - FETT/2);
RULEX_DOT(FETT);
RULEY_DOT(Y_LEN + FETT);
PRINT_RULE;

Print_SteuerKz ("SCHR_FREI");

for (wZeile=0; wZeile < 11; wZeile++)
  {
  POSX_DOT(X_BAS - SPITZ_X);
  POSY_DOT(Y_BAS + wZeile*EH_Y);
  RULEX_DOT(X_LEN+SPITZ_X*2);
  RULEY_DOT(FEIN);
  PRINT_RULE;

  POSX_DOT(X_BAS - ALPHA_X*3);
  POSY_DOT(Y_BAS + wZeile*EH_Y + ALPHA_Y/2);
  fprintf (pfDevice_m, "%3d", 100-wZeile*10);

  POSX_DOT(X_BAS + X_LEN + ALPHA_X);
  POSY_DOT(Y_BAS + wZeile*EH_Y + ALPHA_Y/2);
  fprintf (pfDevice_m, "%d", wZeile*10);
  }

for (wSpalte=0; wSpalte < 18; )
  {
  POSX_DOT(X_BAS+wSpalte*EH_X);
  POSY_DOT(Y_BAS);
  RULEX_DOT(FEIN);
  RULEY_DOT(Y_LEN+SPITZ_Y);
  PRINT_RULE;

  POSX_DOT(X_BAS+wSpalte*EH_X-ALPHA_X);
  POSY_DOT(Y_BAS+Y_LEN+SPITZ_Y+ALPHA_Y);
  fprintf (pfDevice_m, "%s", apstrSieb[wSpalte]);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_Plot (SWORD	wX, SWORD    wY)
{
PSSTR  pstrPos=pstrDataBuffer_g;
SWORD  wBit = 7-wX%8;

pstrPos  += swGrBreite_m*wY+wX/8;
*pstrPos |= (CHAR)(1<<wBit);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_Line (SWORD  wX1, SWORD  wY1, SWORD  wX2, SWORD  wY2)
{

SWORD	 wX, wY,  wZ,  wA,  wB,
      wD, wDX, wDY, wDP, wDQ;
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_WriteFuller (SWORD  wSpalte, SWORD  wDaten_i1, SWORD  wDaten_i)
{
DOUBLE dK;
SWORD	 wX = 3, wSchrittweite = (SWORD )((DOUBLE)ALPHA_X/1.5);

#define BREITE 2

dK = (DOUBLE)(wDaten_i1-wDaten_i)/(DOUBLE)(BREITE*EH_X);

POSX_DOT(X_BAS+wSpalte*EH_X+wX);
POSY_DOT(Y_BAS+Y_LEN-wDaten_i-ALPHA_Y/4-(SWORD )(dK*(DOUBLE)wX));
fputc ('F', pfDevice_m);
wX+=wSchrittweite;
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_ZeichneLinien (SWORD  awDaten[], BOOL boFuller, SWORD	wDicke)
{
SWORD  i, wSpalte, wBreite;
CHAR strInit[20];

for (i=0, wSpalte=0; i<10; i++)
  if (awDaten[i] && awDaten[i+1])
    {
    SWORD  j;
    SWORD    wY, wLauf;
    DOUBLE dAlpha, dY, dX1, dY1, dX2, dY2, dKx, dKy;

    swGrHoehe_m = awDaten[i+1]-awDaten[i];
    if (wSpalte==0)
      wBreite = 3;
    else if (wSpalte < 13)
      wBreite = 2;
    ...
    swGrBreite_m = (wBreite*EH_X)/8+1;
    memset (pstrDataBuffer_g, '\0', MAX_RECORD_SIZE);

    dAlpha = atan((DOUBLE)(awDaten[i+1]-awDaten[i]) /
                  (DOUBLE)(wBreite*EH_X));
    dY = (DOUBLE) wDicke / cos(dAlpha);
    wY = (SWORD ) fabs(floor (dY+0.5));
    dX1 = RADIUS*cos(dAlpha) - (DOUBLE)wDicke/2.0*sin(dAlpha);
    dY1 = RADIUS*sin(dAlpha) + (DOUBLE)wDicke/2.0*cos(dAlpha);
    dX2 = RADIUS*cos(dAlpha) + (DOUBLE)wDicke/2.0*sin(dAlpha);
    dY2 = RADIUS*sin(dAlpha) - (DOUBLE)wDicke/2.0*cos(dAlpha);
    dKx = (dX1-dX2)/2.0/(DOUBLE)wY;
    dKy = (dY1-dY2)/2.0/(DOUBLE)wY;

    if (boFuller && wDicke==DUENN)
      wY = 0;
    ...
    for (wLauf=0; wLauf <= 2*wY; wLauf++)
      {
      SWORD  wXVon, wYVon, wXBis, wYBis;
	...
	wYVon = wLauf;
        wXBis = wBreite*EH_X;
	wYBis = awDaten[i+1]-awDaten[i]+wLauf;
        }
      else
        {
        wXVon = 0;
	wYVon = awDaten[i+1]-awDaten[i]+wLauf;
        wXBis = wBreite*EH_X;
	wYBis = wLauf;
        }

      i_Line (wXVon, wYVon, wXBis, wYBis);
      }

    sprintf(strInit, "\x1b*b%dW", abs(swGrBreite_m));
    wGrInit_m = strlen (strInit);

    for (j=0; j<abs(swGrHoehe_m); j++)
      {
      POSX_DOT(X_BAS+wSpalte*EH_X);
      if (swGrHoehe_m>=0)
        POSY_DOT(Y_BAS+Y_LEN-awDaten[i]-j+wY);
      else
        POSY_DOT(Y_BAS+Y_LEN-awDaten[i+1]-j+wY);
      START_GRAFIK;

      fwrite(strInit, wGrInit_m,
             1, pfDevice_m);
      fwrite(&pstrDataBuffer_g[swGrBreite_m*j],
             swGrBreite_m, 1, pfDevice_m);
    ...
    if (i == 3 && boFuller)
      if (swGrHoehe_m>=0)
	i_WriteFuller(wSpalte, awDaten[i+1], awDaten[i]);
      else
	i_WriteFuller(wSpalte, awDaten[i], awDaten[i+1]);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_ZeichneKreise(SWORD  awMin[], SWORD  awMax[], BOOL aboKreise[])
{
SWORD  wX, wY, i, j, wSpalte;
DOUBLE dX, dY, dAlpha;
CHAR strInit[100];

swGrBreite_m = swGrHoehe_m = 24;
memset (pstrDataBuffer_g, '\0', MAX_RECORD_SIZE);
sprintf(strInit, "\x1b*b%dW", abs(swGrBreite_m));
wGrInit_m = strlen (strInit);

for (dAlpha=0.0; dAlpha<=PI/4.0+0.1;
     dAlpha += 0.05)
  {
  dX = RADIUS*cos(dAlpha);
  dY = RADIUS*sin(dAlpha);

  wX = (SWORD ) floor(dX+0.5);
  wY = (SWORD ) floor(dY+0.5);

  i_Plot (MITTE_X+wX, MITTE_Y+wY);
  i_Plot (MITTE_X-wX, MITTE_Y+wY);
  i_Plot (MITTE_X-wX, MITTE_Y-wY);
  i_Plot (MITTE_X+wX, MITTE_Y-wY);
  i_Plot (MITTE_X+wY, MITTE_Y+wX);
  i_Plot (MITTE_X-wY, MITTE_Y+wX);
  i_Plot (MITTE_X-wY, MITTE_Y-wX);
  i_Plot (MITTE_X+wY, MITTE_Y-wX);
  }

for (wSpalte=0, i=0; i<11; i++)
  if (aboKreise[i])
    {
    for (j=0; j<abs(swGrHoehe_m); j++)
      {
      if (awMin[i])
        {
        POSX_DOT(X_BAS+wSpalte*EH_X-MITTE_X);
        POSY_DOT(Y_BAS+Y_LEN-awMin[i]-j+MITTE_Y);
        START_GRAFIK;
        fwrite(strInit, wGrInit_m,
               1, pfDevice_m);
	fwrite(&pstrDataBuffer_g[swGrBreite_m*(abs(swGrHoehe_m)-j-1)],
               swGrBreite_m, 1, pfDevice_m);
        END_GRAFIK;
        }
      ...
      if (awMax[i])
        {
        POSX_DOT(X_BAS+wSpalte*EH_X-MITTE_X);
        POSY_DOT(Y_BAS+Y_LEN-awMax[i]-j+MITTE_Y);
        START_GRAFIK;
        fwrite(strInit, wGrInit_m,
               1, pfDevice_m);
	fwrite(&pstrDataBuffer_g[swGrBreite_m*(abs(swGrHoehe_m)-j-1)],
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_ZeichneGrafik (VOID)
{
SWORD  i, awMax[20], awMin[20], awFuller[20], awAkt[20];
BOOL aboKreise[20];

if (!i_LiesGutDaten (awMax, awMin, awFuller, aboKreise) ||
    !i_LiesAktDaten (awAkt))
  {
  Print_SteuerKz("DEINIT_ALL");
  fputc('\x0C', pfDevice_m);
  return (!OK);
  }
...
i_ZeichneLinien(awMin, NEIN, DICK);
i_ZeichneLinien(awMax, NEIN, DICK);
i_ZeichneKreise(awMin, awMax, aboKreise);

i_ZeichneLinien(awFuller, JA, DUENN);

i_ZeichneLinien(awAkt, NEIN, DUENN);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_LiesAktDaten (SWORD  awAkt[])
{
DOUBLE dWert;

awAkt[11] = 0;

memcpy (&dWert, point("SUM31_P", 0), 8);
awAkt[10] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM22_P", 0), 8);
awAkt[9] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM16_P", 0), 8);
awAkt[8] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM11_P", 0), 8);
awAkt[7] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM8_P", 0), 8);
awAkt[6] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM4_P", 0), 8);
awAkt[5] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM2_P", 0), 8);
awAkt[4] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM1_P", 0), 8);
awAkt[3] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM05_P", 0), 8);
awAkt[2] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM025_P", 0), 8);
awAkt[1] = (SWORD ) floor(dWert+0.49);

memcpy (&dWert, point("SUM09_P", 0), 8);
awAkt[0] = (SWORD ) floor(dWert+0.49);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
MGLOBAL
SWORD  i_LiesGutDaten (SWORD  awMax[],	  SWORD  awMin[],
		     SWORD  awFuller[], BOOL aboKreise[])
{
CHAR strKey[TB_MAX];
PSSTR  pstrKey;
SWORD  wWert;
...
pstrKey = strKey;
strcpy (pstrKey, point("GUT", 0));

B_GetEq (2,apstrFileBlock_m,			   /* Lesen Datei 2	   */
	  apstrRecord_m, awRecLength_m, 	   /* Antragsteller	   */
	  &pstrKey, 0, "GUTDATEN_1");		   /*			   */

memcpy (&wWert, point("S09_MAX", 0), 2);
awMax[0] = wWert;
memcpy (&wWert, point("S025_MAX", 0), 2);
awMax[1] = wWert;
memcpy (&wWert, point("S05_MAX", 0), 2);
awMax[2] = wWert;
memcpy (&wWert, point("S1_MAX", 0), 2);
awMax[3] = wWert;
memcpy (&wWert, point("S2_MAX", 0), 2);
awMax[4] = wWert;
memcpy (&wWert, point("S4_MAX", 0), 2);
awMax[5] = wWert;
memcpy (&wWert, point("S8_MAX", 0), 2);
awMax[6] = wWert;
memcpy (&wWert, point("S11_MAX", 0), 2);
awMax[7] = wWert;
memcpy (&wWert, point("S16_MAX", 0), 2);
awMax[8] = wWert;
memcpy (&wWert, point("S22_MAX", 0), 2);
awMax[9] = wWert;
memcpy (&wWert, point("S31_MAX", 0), 2);
awMax[10] = wWert;
awMax[11] = 0;

memcpy (&wWert, point("S09_MIN", 0), 2);
awMin[0] = wWert;
memcpy (&wWert, point("S025_MIN", 0), 2);
awMin[1] = wWert;
memcpy (&wWert, point("S05_MIN", 0), 2);
awMin[2] = wWert;
memcpy (&wWert, point("S1_MIN", 0), 2);
awMin[3] = wWert;
memcpy (&wWert, point("S2_MIN", 0), 2);
awMin[4] = wWert;
memcpy (&wWert, point("S4_MIN", 0), 2);
awMin[5] = wWert;
memcpy (&wWert, point("S8_MIN", 0), 2);
awMin[6] = wWert;
memcpy (&wWert, point("S11_MIN", 0), 2);
awMin[7] = wWert;
memcpy (&wWert, point("S16_MIN", 0), 2);
awMin[8] = wWert;
memcpy (&wWert, point("S22_MIN", 0), 2);
awMin[9] = wWert;
memcpy (&wWert, point("S31_MIN", 0), 2);
awMin[10] = wWert;
awMin[11] = 0;

memcpy (&wWert, point("S09_F", 0), 2);
awFuller[0] = wWert;
memcpy (&wWert, point("S025_F", 0), 2);
awFuller[1] = wWert;
memcpy (&wWert, point("S05_F", 0), 2);
awFuller[2] = wWert;
memcpy (&wWert, point("S1_F", 0), 2);
awFuller[3] = wWert;
memcpy (&wWert, point("S2_F", 0), 2);
awFuller[4] = wWert;
memcpy (&wWert, point("S4_F", 0), 2);
awFuller[5] = wWert;
memcpy (&wWert, point("S8_F", 0), 2);
awFuller[6] = wWert;
memcpy (&wWert, point("S11_F", 0), 2);
awFuller[7] = wWert;
memcpy (&wWert, point("S16_F", 0), 2);
awFuller[8] = wWert;
memcpy (&wWert, point("S22_F", 0), 2);
awFuller[9] = wWert;
memcpy (&wWert, point("S31_F", 0), 2);
awFuller[10] = wWert;
awFuller[11] = 0;

aboKreise [0] = (*point("S09_K", 0) == 'j');
aboKreise [1] = (*point("S025_K",0) == 'j');
aboKreise [2] = (*point("S05_K", 0) == 'j');
aboKreise [3] = (*point("S1_K",  0) == 'j');
aboKreise [4] = (*point("S2_K",  0) == 'j');
aboKreise [5] = (*point("S4_K",  0) == 'j');
aboKreise [6] = (*point("S8_K",  0) == 'j');
aboKreise [7] = (*point("S11_K", 0) == 'j');
aboKreise [8] = (*point("S16_K", 0) == 'j');
aboKreise [9] = (*point("S22_K", 0) == 'j');
aboKreise[10] = (*point("S31_K", 0) == 'j');
aboKreise[11] = NEIN;
