...
MGLOBAL PWKB pWkbInfo_m = NULL;          /* Window fr Testmodus == ein       */
...
printf("\nฏ%sฎ / ฏ%dฎ",astrRecordKey_m[1], wBufLen_m);
Btr_Insert(1, "INS_0");
...
if(apstrOwner[wFileHandler])			      /* Falls Besitzername  */
  wOwnerLength=strlen(apstrOwner[wFileHandler])+1;    /* da, Lnge speichern */
