// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 11:22:43 - Wed

/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  Programme-Name: SY_4100.C	     Revision: 1.3	   (C) 1989/1991    บ
  บ  Function	   : Initialisieren -> Drucken euroSOFT-Systemdaten,	    บ
  บ		       Konstanten ...					    บ
  บ                                                                         บ
...
switch(*pwSteuerKz)
  ...
  case 20:					     /* SY-Druck	     */
    ...
    switch(*pwDruckKz)				     /* Formular fr Mandant */
      {case '0': *pwForm=1200; break;}		     /* 		     */
    break;

  case 40:					     /* SY-Listen	     */
    iInit(pstrApp, "SY", pstrAppDru, "SY", awMasks,  /* Druck Menzeilen     */
      "4020", "20", "36", _N);			     /* Block-Maske	     */

    switch(*pwDruckKz)				     /* Formular fr Menue   */
      {case '0': *pwForm=4020; break;}		     /* 		     */

    iDruInit("MENGRUPPE", "_VON-MEN", "_BIS-MEN");
    break;
