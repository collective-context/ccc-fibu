...
บ  eur_mnu.h    ... Headerdatei fr euroSOFT-TOOLbox Men-Funktionen.          บ
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
   ...
   #define MENUZEILE       1            /* Zeile fr Ausgabe der Menzeile     */
   #define MENUSPALTE       1           /* Spalte fr Ausgabe der Menzeile    */
   #define MENULAENGE       78          /* Laenge fr Ausgabe der Menzeile    */
   #define FENSTERZEILE      2          /* Zeile fr alle Menfenster          */
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ bergabe an i_Mn_Balken() und i_Mn_Titel()                              บ
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ                                                                         บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
   #define EIN_REL  20
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ bergabe an i_Mn_SetPalette()                                           บ
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ                                                                         บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ Konstanten,                                                             บ
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ deren Wert im Fehlerfalle nach wFehler_g geladen werden. Alle Fehler-   บ
  บ nummern fr das Mn-Modul liegen im Bereich 501..599                     บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
   #define MNU_KEIN_FEHLER      0  /* kein Fehler aufgetreten                   */
   #define MNU_KEIN_PMKB      501  /* kein gltiger Zeiger auf einen MKB        */
   #define MNU_ZU_GROSS       502  /* Fensterdimensionen ungltig               */
   #define MNU_KEIN_SPEICHER  503  /* Ihr Rechner kann sich nichts merken       */
   #define MNU_FALSCHE_OPT    504  /* gewhlte Option nicht vorhanden           */
   #define MNU_TITEL_LAENGE   505  /* Titel zu lang                             */
   #define MNU_AUSSERHALB     506  /* Koordinaten liegen auแerhalb des Windows  */
   #define MNU_LIMIT          507  /* Men zu groแ                              */
   #define MNU_NICHT_SICHTBAR 508  /* Inaktive Fenster k”nnen nicht versteckt w.*/
   #define MNU_NICHT_REG      509  /* Das W. ist nicht als sichtbar registriert */


/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ Konstanten zur bergabe an Mn_Marker() und Mn_Option()                  บ
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ                                                                         บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
   #define AUS             0
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
   ...
   typedef struct
   {
       unsigned wAktiv   : 1;           /* Menmanager aktiv   0=nein, 1=ja    */
       ...
       unsigned wDummy   : 12;          /* zum Auffllen auf 16 Bit            */
   }MENUSTATUS;


   typedef struct tagMKB
   {
       SWORD	       wMkbsign;	 /* Menfensterkontrollblock-Signatur	*/
       SWORD	       wFensterId;	 /* Identifikationsnr. des Menfensters */
       SWORD	      wTitelSpalte;	/* Startspalte und Breite der Schalt-  */
       SWORD	      wTitelBreite;	/*   flche zum Aktivieren per Maus    */
       SWORD	      wSpalte;		/* linke obere Spalte des Menfensters */
       SWORD	      wBreite;		/* Breite des Menfensters ink. Rahmen */
       SWORD	      wHoehe;		/* H”he des Menfensters inkl. Rahmen  */
       ...
       SWORD	      wItemAnzahl;	/* Anzahl der Menitems 	       */
   ...
   typedef struct
   {
       ...
       unsigned wDummy	     :10;    /* auf SWORD-Gr”แe auffllen	     */
   } MKB_STATUS;
