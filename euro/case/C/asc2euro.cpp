...
#include "\euro\c\ba_proto.h"
  ...
  /* 0028.0  ~0.NAME=		       \\A.NAME1			   บ
  บ  0000.0  ~0.BRIEFANR_1="Sehr geehrte Damen und Herren"		   บ
  บ  0000.0  ~1.FI_KU_KTO=~0.KUNDE					  */

/*
ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
ณ DATEINUMMER  FIMASK.043  Dateiname                                           ณ
ณ ภฤฤฤฤฤฤฤฤู  ภฤฤฤฤฤฤฤู  ภฤฤฤฤฤฤู                                           ณ
ณ &DATEI (0) = FIMASK, ST1100 ฤฤฟ                                              ณ
ณ &DATEI (1) = FIMASK, ST1110   ร euroSOFT ฏZIELDATEIENฎ                      ณ
ณ &DATEI (2) = FIMASK, FI1110 ฤฤู                                              ณ
ณ                                                                              ณ
ณ &FELDER ฤฤฤ Damit beginnt die Beschreibung der ฏQUELLDATEIฎ                 ณ
ณ 0005.0  ~0.KUNDE		    \\Kundennummer ฟ			       ณ
ณ 0028.0  ~0.NAME		    \\Name1 ฤฤฤฤฤฤฤม Remarkzeichen: \\        ณ
ณ 0028.0  ~0.ZUSATZ ฤฤฤฤ Dateinummer und Feldname in ST1100 (FIMASK.043).     ณ
ณ 0001.0  ~1.PREIS_GR=1 ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ                      ณ
ณ 0006.0  ~1.KONDITION=10-30-030                        ณ                      ณ
ณ 0000.0  ~0.BRIEFANR_1="Sehr geehrte Damen und Herren" ร Defaultwerte        ณ
ณ 0008.M  ~0.GEBURT_1=s                                 ณ  s: Systemdatum      ณ
ณ 0013.D  ~1.UMSATZ_PER=123.5 ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู                      ณ
ณ 0004.0  ~0. ฤฤฟ Offset der Quelldatei hochzhlen.                           ณ
ณ 0003.0  ~0. ฤฤู                                                              ณ
ณ 0000.0  ~1.FI_KU_KTO=~0.KUNDE ฤฤฤฤฤฟ                                         ณ
ณ 0000.0  ~2.KU_KONTO=~0.KUNDE       ร Kopiert Inhalt des 2. aufs 1. Feld.    ณ
ณ 0000.0  ~2.KURZ_BEZ=~0.MATCH_CODE ฤู                                         ณ
ณ         ฤฤฤ Dateinummer der euroSOFT Zieldatei.                            ณ
ณ ภฤฤ Feldlnge zhlt Offset der Quelldatei hoch. Ab dem Punkt ein Remark.     ณ
...
if(argc<2 || argc>3) {printf("\a\n!!! Fehler:"
  ...
  "\n"
  "\n"
  "\nDie Eingabemarke steht im Verzeichnis ฏ\\euro\\exeฎ, "
  "\ndie Dateien *.SEQ und *.LEX im Verzeichnis ฏ\\euro\\datฎ."
  "\n"
...
for(wF=0; apstrFileName_g[wF]; wF++)
  sprintf(strL1, "ฏ%s.%sฎ ฏ%sฎ", apstrMask_m[wF], strExt_g,
    apstrKey_m[wF]);
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  CopyToDest()							    บ
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ  0028.0  ~0.NAME=		       \\A.NAME1			    บ
  บ  0000.0  ~0.BRIEFANR_1="Sehr geehrte Damen und Herren"		    บ
  บ  0000.0  ~1.FI_KU_KTO=~0.KUNDE					    บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
STATIC
...
/*printf("\npTB:ฏ%sฎ, wOff:%d.", pTB->pstrDatenfeld, pTB->wOffset);*/
return(&apstrRecord_g[wF][pTB->wOffset]);
}

/* printf("\npTB:ฏ%sฎ, wLen:%d.", pTB->pstrDatenfeld, *pwLen); */
...
for(pstr=pstrLex; *pstr; pstr++)		     /* Nicht relevante CHAR */
  if(*pstr=='=' || *pstr==',') *pstr=' ';	     /* mit BLANK berschr.  */

for(pstr=pstrLex; *pstr; pstr++)		     /* Zwischen " " in ge-  */
  {if(*pstr=='"') boEin=(boEin) ? NEIN : JA;	     /* geschtzte Leerzeich.*/
  if(*pstr==' '&&boEin) *pstr='ÿ';}		     /* BLANK in ALT 255     */

for(pstr=strtok(pstrLex," ");			     /* Blanks sind Trenn-   */
  pstr; pstr=strtok(NULL, " ")) 		     /* zeichen, also alle   */
  *ppstrCode++=pstr;				     /* W”rter auf ppstrCode */
*ppstrCode=NULL;

for(; *ppstr; *ppstr++) 			     /* Fr jedes Wort die ge*/
  for(pstr=*ppstr; *pstr; pstr++)		     /* schtzten Leerz. ret.*/
    if(*pstr=='ÿ') *pstr=' ';			     /* ALT 255 in BLANK     */
...
/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  บฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤบ
  บ  &FELDER								   บ
  บ  0005.0  ~0.KUNDE		       \\A.KUNDENNUMMER 		   บ
  บ  0028.0  ~0.NAME=		       \\A.NAME1			   บ
  บ  0000.0  ~0.BRIEFANR_1="Sehr geehrte Damen und Herren"		   บ
  บ  0000.0  ~1.FI_KU_KTO=~0.KUNDE					   บ
  ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
...
/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  InitDestFile()					   Datum: 13.01.92 บ
  บฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤบ
  บ                                                                        บ
  ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
STATIC
...
/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  DataDictionary					   Datum: 13.01.92 บ
  บฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤบ
  บ                                                                        บ
  ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
STATIC
...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  ...
  บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
  บ Diese Funktion schreibt im File wFH den Schlssel strSelection_g laut   บ
  บ Key-Nummer wK.                                                          บ
  บ In apstrRecord_g[wFH] und strSelection_g muแ der richtige Schlssel     บ
  บ stehen.                                                                 บ
  ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
GLOBAL
