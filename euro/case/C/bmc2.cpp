...
mask_buffer.wNdxCnt = 1;                /* Nummer der Index-Eintrge           */
                                        /*------------------------------*/
mask_buffer.ksKeyBuf[0].wKeyPosition = 7;           /* Key 0 Position 1 Stelle              */
mask_buffer.ksKeyBuf[0].wKeyLength = 10;             /* Key 0 Lnge 10 Zeichen               */
...
for(i=0; apTextBox_m[i] && apBlocks[i]; i++)	     /* in letzter Box steht */
  ...
  if(apBlocks[i]==NULL && apTextBox_m[i+1]!=NULL)  /* Problem !!! letztes TB muแ */
    Dl_Abbruch("Bibl.eintr.", _L, _F,		   /* zweimal vorkommen, da	 */
      str("pBlocks%s", apBlocks[i]));		   /* apBlocks[i] zufrh leer	 */
...
/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ                       BLOCKDATEN IN BILBIOTHEK EINTRAGEN               บ
  ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
...
if (swRetCode == 0 || swRetCode == 22)
   {
    printf ("\n\nLetztes Update vom %s wurde gel”scht und durch die Maske\n%s ersetzt.\n\n\n\n",
