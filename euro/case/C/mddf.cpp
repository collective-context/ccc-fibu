...
//บ MakeDDF()					   Datum: 19.05.94 / xx.xx.xx บ
//บฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤบ
//บ									      บ
//บ mddf	= Zeige Inhalt von FILE.DDF				      บ
//บ mddf X$FILE G:\WINware\FILE.DDF = ndere Eintrag in FILE.DDF	      บ
//บ mddf ST1100 = ndere Eintrge: FILE.DDF & FIELD.DDF aus EURODATA.BTR      บ
//บ mddf ST1111 /Nr:4 = ndere Eintrge: FILE.DDF & FIELD.DDF aus EURODATA.BTRบ
//บ mddf ST1111 /del = Delete: l”schen in FILE.DDF & FIELD.DDF.\n\n");        บ
//บ									      บ
...
if(argc==2)
  if(*argv[1]=='?' || *(argv[1]+1)=='?')
    {printf("\nฏmddfฎ        = Zeige Inhalt von FILE.DDF");
    printf("\nฏmddf X$FILE C:\\WINware\\FILE.DDFฎ = ndere Eintrag in FILE.DDF");
    printf("\nฏmddf ST1100ฎ ndere Eintrge: FILE.DDF & FIELD.DDF aus EURODATA.BTR");
    printf("\nฏmddf ST1111 /Nr:4ฎ = ndere Eintrge: FILE.DDF & FIELD.DDF aus EURODATA.BTR");
    printf("\nฏmddf ST1111 /delฎ = Delete: l”schen in FILE.DDF & FIELD.DDF.\n\n");
    D_end_process (0);}
...
//บ FIELD.DDF								      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
if(pstrFile && pstrDir==NULL)	    // Mehr als nur FILE.DDF anschauen/ndern
  {
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_EqFile()				   Datum: 19.05.94 / xx.xx.xx บ
...
if(wRetCode == 4)
  ...
  if(wXfId_m==0)
    ...
    Ut_SchreibArray(apstrMessage,
      "Bei Neueintrgen muแ in FILE.DDF eine freie Dateinummer gewhlt werden:",
      "ฏmddf ST1111 /Nr:4ฎ = ndere Eintrge: FILE.DDF & FIELD.DDF aus EURODATA.BTR", _N);
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_InsFile()				   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_EqField()				   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
if(wRetCode==4)
  ...
  Ut_SchreibArray(apstrMessage,
    str("Noch keine ฏfieldsฎ zur Dateinummer [%#03d]", pDdfFile_m->wXfId), _N);
  Dl_Info(apstrMessage, DLG_INFO);
  Ut_LoeschArray(apstrMessage);
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_EqData()				   Datum: 19.05.94 / 22.05.94 บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
if(wFirst++ == 0)
  ...
  if(wRetCode==4)
    ...
    Ut_SchreibArray(apstrMessage,
      str("Kein Eintrag ฏ%sฎ in EURODATA.BTR", strKey), _N);
    ...
    sprintf(strError,"DDF_EqData(B_GET_EQ), - Key: ฏ%sฎ", strKey);
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_InsField()				   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_Create()				   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_Open()					   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
...
//ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
//บ DDF_Close() 				   Datum: 19.05.94 / xx.xx.xx บ
//วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
//บ									      บ
//ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
STATIC
