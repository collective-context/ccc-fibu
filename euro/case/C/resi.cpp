...
VOID main()
{
fpwScreen_m = MK_FP(0xb000,0);		  /* fr Hercules-Karte 0xb000,0    */
					  /* fr EGA-Karte o.. 0xb800,0    */

pwBegin = &_psp;			  /*Programmganfang*/
pwEnd	= sbrk(0);			  /*Programmende   */
wSize	= (pwEnd - pwBegin + 15) / 16;	  /*Programmgr”แe  */
...
Beispiel:
ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
Den Einsatz dieser Funktion k”nnen Sie in dem Beispielprogramm ฏVi_Demo.cฎ
studieren. ฏVi_Sw2b()ฎ wird dort in der Funktion ฏmain()ฎ aufgerufen, um den
