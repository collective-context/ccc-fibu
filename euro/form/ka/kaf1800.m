...
&KOPF (0)
^зыRechnungsausgangsbuch                        Monat: @@@@@@@@@@@@@                     Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~SM ~1Ь_W_MONAT ~1._DATUM_AKT ~1._SEITE
...
Lauf.Ё  Beleg Ё Beleg      Buchungsart                                                    MwSt-    MwSt-       Konto-
  Nr.Ё  Datum Ё Nr.          Buchungstext                                     Einnahmen     Satz     betrag     nummer
дддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
&ENDЪЪ

&KOPF (1)
^зыRechnungsausgangsbuch                           Jahreswerte                           Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~SM ~1._DATUM_AKT ~1._SEITE
Ёздддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд©Ё
ю╢Mandant (⌡⌡) @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@                                                        Teilnehmer: ⌡⌡⌡цы ~1._NR_MAND ~1._MANDANT ~1._TEILN
 юдддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддды
...
&RUMPF (0)
⌡⌡⌡⌡⌡ ##.##.## @@@@@@@@@@ @@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@               ##.###.##⌡,⌡⌡  @@@@@@@ ###.##⌡,⌡⌡     @@@@@@ ~1._LAUFENDNR ~0.BEL_DATUM ~0.BELEGNR ~0ЬZAHLUNG ~0.BUCH_TEXT ~0.EINNAHMEN ~0ЬUST_SATZ ~0.UST_BETR ~0.KONTONR
&END

&FUSS (0)
Summe Rechnungsausg└nge f│r das Monat   @@@@@@@@@@@@  ##.###.##⌡,⌡⌡                                                   ~1Ь_W_MONAT ~1._K-STAND
