...
&KOPF (0)
Ъ
^зыADRESSLISTE LIEFERANTEN                             Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~NO ~1._DATUM_AKT ~1._SEITE
...
Lieferant.Nr Anrede                              Kurzbezeichnung
             Name                                StraАe
             Zusatz                              Land - PLZ/Ort
...
&RUMPF (0)
Ъ
@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  ~0.LIEFNR ~0.ANREDE  ~0.MATCH_CODE
             @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  ~0.NAME   ~0.STRASSE
