...
echo mf4 [- ] formularnummer / FC [- ]formularnummer
echo --------------------------------------------------------------------
echo z.B.: mf4 4100 fuer die Sachkonten-Saldenliste
echo oder: mf4 - 4100 um die Saldenliste zu entfernen.
echo ÿ
echo ID=%ID% APP=%APP% EXT=%EXT% MAN=%MAN%
echo --------------------------------------------------------------------
echo Ziel: dir \euro\dat\*.044
echo
goto ende
