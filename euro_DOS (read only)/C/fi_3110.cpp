// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 12:14:04 - Wed
...
switch(*pwSteuerKz)
  {
  case 20:                                           /* FI-Work              */
    pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* L”schen Salden       */
  ...
  case 30:					     /* FI-Work 	     */
    ...
    iInit(pstrApp, pstr, pstrAppDru, pstr, awMasks,  /* Jahr l”schen und     */
  ...
  /* case 40:					       /* FI-Work	       */
  /*  pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* Jahr l”schen und     */
  ...
  case 42:                                           /* FI-Work              */
    pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* bernahme EBK aus    */
...
else if(Maske(0,"FI4320","LKF4320","FI4340","LKF4340",_N))/* L”schen Fibu	  */
  {SWORD wSelect;
  if(wSteuerKz_m==35) wSelect=0;
  else M_OkQuestion(&wSelect,"Bitte whlen Sie:",
    "#L”schen der Dateien.","#Abbruch ohne l”schen.",
