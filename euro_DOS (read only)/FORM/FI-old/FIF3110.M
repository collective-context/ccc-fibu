...
&KOPF (0)
^зыBUCHUNGS-JOURNAL                                                                      Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~SM ~1._DATUM_AKT ~1._SEITE
...
&RUMPF (1)
зKontoд© зBezeichnungддддд© здддддVortrag© здMonats-Soll© зMonats-Haben© здJahres-Soll© зJahres-Haben© зддддддддSaldo©
ю@@@@@@@ @@@@@@@@@@@@@@@@@@ ###.###.##⌡,⌡⌡ ###.###.##⌡,⌡⌡ ###.###.##⌡,⌡⌡ ###.###.##⌡,⌡⌡ ###.###.##⌡,⌡⌡ ###.###.##⌡,⌡⌡ы \
...
&FUSS (0)
дддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
Journal-Ums└tze auf Sachkonten:          ##.###.###.##⌡,⌡⌡ ##.###.###.##⌡,⌡⌡ ~1._SUMME_SO~1._SUMME_HA
