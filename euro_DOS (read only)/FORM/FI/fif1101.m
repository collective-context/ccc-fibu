...
&KOPF (0)
^зыLISTE KUNDENKONTEN NACH KURZBEZEICHNUNG             Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~NO ~1._DATUM_AKT ~1._SEITE
...
&RUMPF (0)
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ K@@@@@@@@ @@@@@@@@@@@@ @@@@@@@@@ @@@@  @@@@@@@ @@@@@@ ~0.KURZ_BEZ ~0.KU_KONTO ~2.KUNDE ~0.KONDITION ~0ЬAUSLANDSKU ~0ЬW▌HRUNG ~2.KUNDEN_GR
&END
