...
CHAR     *BackSpace    = NULL;    /* Zeiger auf String fÅr "1 Zeichen zurÅck"   */
CHAR     *NewPage      = NULL;	  /* Zeiger auf String fÅr "neue Seite"         */
...
VOID HeadLine ( VOID )
{
     clrscr();
     printf("--------------------------------------------------------------------------------");
     printf("        MÅck Softwareentwicklung C - Druckertoolbox - Druckerdefinition\n\r");
     printf("--------------------------------------------------------------------------------\n\r");
}
...
VOID main ( VOID )
{
     ...
     {
	  HeadLine();
	  printf("Code fÅr `1 Zeichen zurÅck` (Hex, meist 08): ");
	  EnterHexCode( &BackSpace, 1 );

	  printf("\n\r\n\r");
	  printf("Code fÅr `neue Seite` (Hex, meist 0C): ");
	  ...
	  printf("\n\r\n\r");
	  printf("ZÑhlerÅbergabe auf (H)P-Laser oder (E)SC-Nadel Art: ");
     ...
     do
     {
	   ...
	   HeadLine();
	   printf("Bitte editieren Sie Font %d von %d verfÅgbaren Fonts. Font 1 ist Standardfont", AktFont, Fonts );
	   printf("\n\r\n\r\n\r");
