...
/*ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  Programme-Name: FI1500.C        Revision: 1.3         (C) 1989/1991    บ
  บ  Function      : Erfassen Buchungen, Erfassen Geldbuchungen,            บ
...
if(Maske(wMsk,"FI210","LKF210",_N))
  {boJump_g=NEIN;				     /* Felder n. berspr.   */
  Fi210_Application_Set(wMsk, wFld);}
else boJump_g=JA;				     /* Felder berspringen  */
...
if(Maske(_MSK,"FI211","FI212",_N))
  ...
  if(awRecLength_g[wF] > 19800-awBlockLength_g[_MSK])
    ...
    {Ut_SchreibArray(apstrMessage,
      "Information: Beachten Sie bitte, daแ Sie sich ",
...
switch(wKeyCode_g)                                   /*                      */
  ...
  case T_C_L:
    if(Maske(_MSK,"FI210","FI211","FI212",_N))
      {PSSTR apstrMessage[25];
      Ut_SchreibArray(apstrMessage,
       "Wenn Sie den Betrag auf ฏ0.00ฎ ",
       "setzen wird automatisch gel”scht!", _N);
      Dl_Info(apstrMessage, DLG_INFO);
      Ut_LoeschArray(apstrMessage);
      return(OK);}
      break;
...
if(!awExistingRecord_g[0])			     /* Damit bei <ู und lt. */
...
if(Maske(0,"FI210","LKF210",_N))		     /* Erfassen Buchungen   */
  ...
  memcpy(pt(":SALDO_SOL"), pt(chi(pTB->wRecord,"x๘SALDO")), 8);
  ...
  memcpy(pt(":SALDO_HAB"), pt(chi(pTB->wRecord,"x๘SALDO")), 8);
...
/* {BOOL boTest=boTestModus_g; boTestModus_g=JA;
  Wi_TestPrintf(pWkbInfo_g, "\nstrSelection_g: ฏ%sฎ", strSelection_g);
  boTestModus_g=boTest;} */
...
/*{BOOL boTest=boTestModus_g; boTestModus_g=JA;
  Wi_TestPrintf(pWkbInfo_g, "\nBuchart: ฏ%d/", lBuchArt);
  Wi_TestPrintf(pWkbInfo_g, "%dฎ.", lNichtBebuchen);
  boTestModus_g=boTest;}*/
...
if(Maske(_MSK,"FI254","LKF254",_N) &&
  ...
  strcpy(pt("AR_BEZEICH")+wB, pt("6๘MATCH_CODE"));
