// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 11:27:30 - Wed
...
//บ Cut_Block()                                                               บ
//บ ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ บ
//บ                                                                           บ
...
if(Maske(_MSK,"ST135","LKS135","ST336","LKS336",_N)  // Artikel in Fibu
  ...
  *pwNbFile=*pwFileNb=pTB->wRecord;
  ...
  "Die nchste Nummer aus den Nummernkreisen holen?", _N);
  Dl_Info(apstrMessage, DLG_INFO);
  Ut_LoeschArray(apstrMessage);
