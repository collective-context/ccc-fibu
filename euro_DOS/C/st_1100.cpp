...
switch(*pwSteuerKz)
  ...
  case 100:					      /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Erl”scode	  */
      "100", _N);
    break;
  ...
  case 132:                                          /* ST-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Schnellnder.Artikel */
      "136", _N);
  ...
  case 240:                                          /* KA-Stamm Anlegen     */
    ...
    M_InitMemo(&pstrMemoFile_g, "KA1300M",          /* Fr Notizen je Daten-*/
      &pstrMemoTitel_g,"Allgemeine Kassabuch-Notiz " /* satz > allgemein     */
                       "fr diesen Tag");            /*                      */
    pstrAppTitel_g=
      strdup("Spezielle Kassabuch-Notiz fr diesen Tag"); /* Spezielle appli.*/
  ...
  case 250:					     /* KA-Stamm Anlegen     */
    ...
    M_InitMemo(&pstrMemoFile_g, "KA1500M",	    /* Fr Notizen je Daten-*/
      &pstrMemoTitel_g,"Allgemeine Kassabuch-Notiz " /* satz > allgemein     */
                       "fr diesen Tag");            /*                      */
    pstrAppTitel_g=
      strdup("Spezielle Kassabuch-Notiz fr diesen Tag"); /* Spezielle appli.*/
