...
&KOPF (0)
^зыLISTE LIEFERANTENKONTEN NACH KONTONUMMER            Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~NO ~1._DATUM_AKT ~1._SEITE
...
&RUMPF (0)
L@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@ @@@@@@@@@ @@@@  @@@@@@@ @@@@@@ ~0.LI_KONTO ~0.KURZ_BEZ ~2.LIEFNR ~0.KONDITION ~0ЬAUSLANDSLI ~0ЬW▌HRUNG ~2.LIEFGR
&END
