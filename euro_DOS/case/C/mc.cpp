...
for(i=0; apTextBox_m[i+1]; i++)                      /* in letzter Box steht */
  ...
  if(pTB->strDatenfeld[0]=='\0' || pTB->strDatenfeld[0]==' ')
    ...
    Ut_SchreibArray(apstrMessage,
      ...
      "Beschreibungen im Positionsteil dafr gibt:",
      "ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ ",
      " ",
      str("Die Textbox mit der Nr ฏ%dฎ hat keinen Namen. ",i),
      " ",
...
if(wError)
  ...
  fprintf(pfHandle, "\nฏError in Line(%#03d)ฎ Þ "
  "%s: ฏ%sฎ.", L_, pstrCode, apstrWort[3]);}
else
  fprintf(pfHandle, "\nSetInsert(%d): ฏ%s(%d)ฎ.",
...
/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  i_DataDictionary() 				   Datum: 13.01.92 บ
  วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
  บ                                                                        บ
  ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ*/
STATIC
...
Dl_ErrorHandler(wRetCode, str("SetData(B_EQ)"	     /* 		     */
  ", - Schlssel: %s", strKeyName), _F, _L, wHandle);
...
if(*pstrTitel==(CHAR)'ฤ') {boSymbol=JA; pstrTitel++;}
