...
º  Db_GetGreater()   ... liest einen Datensatz gr”áer dem Schlssel	       º
ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼

šberblick:     !!! Vorsicht Beschreibung von B_Insert() !!!
ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
#include <eur_btr.h>
SWORD Db_GetGreater(wFileHandler, ppstrFileBlock, ppstrRecord, pwRecLength,
...
Welches der Arrays von der ¯B_Insert()® Funktion verwendet wird h„ngt vom Inhalt
¯wFileHandler® ab.
...
/*ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
  ...
  ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼*/
GLOBAL
SWORD Db_GetGreater(SWORD wFile,      PPSTR ppstrBlock,   PPSTR ppstrRecord,
...
while(wSelect!=0)
  ...
  wStatus=BTRV(B_GET_GREATER+wLock,*(ppstrBlock+wFile),
  ...
  sprintf(strError,"Db_GetGreater(%d), - File/Key: " /* 		     */
