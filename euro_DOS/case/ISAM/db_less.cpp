...
º  Db_GetLess()   ... liest einen Datensatz kleiner dem Schlssel	       º
...
#include <eur_btr.h>
SWORD Db_GetLess(wFileHandler, ppstrFileBlock, ppstrRecord, pwRecLength,
	     wLock, pstrRecKey, wKeyNumber, pstrErrMark);

Parameter fr LessOrEqual:
ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
/*ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
  ...
  ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼*/
GLOBAL
SWORD Db_GetLess(SWORD wFile,	   PPSTR ppstrBlock,   PPSTR ppstrRecord,
...
while(wSelect!=0)
  ...
  wStatus=BTRV(B_GET_LESS+wLock,*(ppstrBlock+wFile), /* 		     */
  ...
  sprintf(strError,"Db_GetLess(%d), - File/Key: "    /* 		     */
