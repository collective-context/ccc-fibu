...
Beschreibung:
ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
Die Funktion l”scht die gewnschte Zeile, indem Sie den Fensterinhalt unterhalb
der Zeile nach oben scrollt.

Die nachrckende Zeile wird mit Leerzeichen aufgefllt. Das Attribut der Leer-
zeichen wird der Variablen ฏwAttribut_gฎ entnommen, die eine Kopie der Variablen
ฏwInnenAttrฎ aus der WKB-Struktur des aktuellen Windows enthlt.		      บ

Die Position des Cursors wird durch die Funktion nicht verndert.
