// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 11:18:27 - Wed
...
if(Maske(_MSK,"LO130",_N) && TBox("VERR_BETR"))
  ...
  if(ptoD(pt("VERR_BETR")+wBlk) == 0 && *(pt("VERR_VON")+wBlk) )
    ...
    {SWORD wSelect;
    M_OkQuestion(&wSelect, "Verrechnungsbetrag berschreiben?",
      "#Ja, Betrag berschreiben.",
      "#Nein, Betrag nicht berschreiben.", _N);
