// (C) FiCore - Open Source Financial Core  Letztes Update am 29-Apr-1996 / 16:39:23 - Mon
...
if(Maske(0,"FI4115","LKF4115","FI4125","LKF4125",    /* Kunden-Salden	     */
  ...
  PSSTR pstrKto; boZwSumme_g=NEIN;		      /* Kapitalflußrechnung  */
  ...
  if(Fkb_g.wAktZeile==Fkb_m.wAktZeile &&	     /* Formularkopf mark.   */
    Maske(0,"FI4140","LKF4140",_N))		     /* Kapitalflußrechnung  */
...
if(Maske(_MSK,"FI4140","LKF4140",_N))
  Calc_Kapital();				     /* Kapitalflußrechnung  */
...
if(boNewLoop_g) 				   /* Kapitalflußrechnung  */
...
if(Maske(_MSK,"FI4140","LKF4140",_N))
  ...
  if(boOnePrinted_g && !boUserBreak_g)
    ...
    Fkb_m.wNextHeader=Fkb_g.wNextHeader;	     /* nächster Kopf	     */
    Fkb_m.wNextFoot=Fkb_g.wNextFoot;}		     /* nächster Fuß	     */
...
/*╔═════════════════════════════════════════════════════════════════════════╗
  ║ Calc_UstVa()							    ║
  ║ ─────────────────────────────────────────────────────────────────────── ║
  ║ "Case-Variante" mit CL.EXE 8.00c nicht kompilierbar!                    ║
  ╚═════════════════════════════════════════════════════════════════════════╝
STATIC
VOID Calc_UstVa()
{
...
User: »V:\euro\t02«  /  Source-File: »\euro\C\FI4100a.CPP« / »FI4100a«
