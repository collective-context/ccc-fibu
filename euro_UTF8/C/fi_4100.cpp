...
switch(*pwSteuerKz)
  ...
  case 30:                                           /* FI-Stamm Anlegen     */
    ...
    switch(*pwDruckKz)                               /* Formular für Liste   */
      ...
      case  '1': *pwForm=301; break;                 /* Sachk. jetzt/früher  */
      case  '2': *pwForm=302; wNdx_g=2; break;}      /* Sachk. früher/jetzt  */

    if(*pwDruckKz=='2')                              /* Formular für Liste   */
  ...
  case 111:                                          /* ST-Stamm             */
    ...
    iDruInit("KURZ_BEZ","_V_KURZBEZ","_B_KURZBEZ");  /* Formular für Liste   */
    break;
  ...
  case 112:                                          /* ST-Stamm             */
    ...
    iDruInit("MATCH_CODE","_V_KURZBEZ","_B_KURZBEZ");/* Formular für Liste   */
    break;
  ...
  case 120:                                          /* ST-Listen            */
    ...
    iDruInit("LI_KONTO", "_V_KONTONR", "_B_KONTONR");/* Formular für Liste   */
    break;
  ...
  case 211:                                          /* FI-Druck             */
    pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* Buchungserfassung    */
    strcpy(pstrApp, pstr);                           /*                      */
    strcpy(pstrAppDru, pstr);                        /* Formular für Liste   */
    iInit(pstrApp, pstr, pstrAppDru, pstr, awMasks,
      "4211", "36", _N);
...
switch(*pwSteuerKz)
  ...
  case 320:                                          /* FI-Druck / Protokoll */
    ...
    iDruInit(".KONTO_NR", "_V_KTONR", "_B_KTONR");   /* Formular für Liste   */
    break;

  case 330:                                          /* FI-Druck             */
    pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* Kontoblätter         */
...
*/
  ...
  case 440:                                          /* FI-Auswertung        */
    pstr=(cKz_g=='L') ? stp("LKF") : stp("FI");      /* Kapitalflußrechnung .*/
    iInit(pstrApp, pstr, pstrAppDru, pstr, awMasks,
      "4140", "4141", "36", _N);
