...
if (wRetCode && (boStrCmp(strMask_m[0], "PB4155")))  /* Asphalt Prüfprotokoll*/
  {                                                  /* und Messprotokoll    */
...
if (boStrCmp(strMask_m[0],"PB4155"))		     /* Asphalt Prüfprotokoll*/
  {
...
if (boStrCmp(strMask_m[0], "PB4150") ||              /* Asphalt Messprotokoll*/
    boStrCmp(strMask_m[0], "PB4155") || 	     /* Beton Prüfprotokoll  */
...
if (boStrCmp(strMask_m[0], "PB4130") ||              /*                      */
    boStrCmp(strMask_m[0], "PB4155"))		     /* Asphalt-Prüfungen    */
