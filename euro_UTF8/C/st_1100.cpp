// (C)WINware Software, P.Mayer  Letztes Update am 14-Feb-1996 / 11:37:23 - Wed

/*╔═════════════════════════════════════════════════════════════════════════╗
  ║  Programme-Name: ST_1100.C       Revision: 1.3         (C) 1989/1991    ║
  ║  Function      : Initialisieren ->euroSOFT Stammdaten für:              ║
...
switch(*pwSteuerKz)
  ...
  case 15:					     /* FI-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* KZ Jahreswerte       */
      "50", _N);
    break;                                           /* abh. Notiz/Record    */

  case 16:					     /* FI-Stamm Abschließen */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /* des Jahres	     */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* KZ Jahreswerte       */
      "51", _N);
    break;                                           /* abh. Notiz/Record    */
  ...
  case 40:                                           /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Werbetexte 1/1       */
      "92", _N);
    break;

  case 50:                                           /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Versandart 1/1       */
      "93", _N);
    break;
  ...
  case 70:                                           /* TE-Anlegen/Ändern    */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Kopftext	       */
      "10", _N);
    break;
  ...
  case 90:                                           /* FI-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Festkonten	       */
      "20", _N);
    break;                                           /* abh. Notiz/Record    */

  case 91:                                           /* FI-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Buchungstexte        */
      "30", _N);
    break;                                           /* abh. Notiz/Record    */

  case 92:                                           /* FI-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Mahntexte	       */
      "40", _N);
    break;					     /* abh. Notiz/Record    */

  case 100:					      /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Erlöscode	  */
      "100", _N);
    break;

  case 102:					      /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Aufwandscode	  */
      "102", _N);
    break;

  case 104:					      /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Aufwandscode	  */
      "104", _N);
    break;

  case 110:                                          /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Kunden-Stamm 1/2     */
      "110", "111", _N);
  ...
  case 112:                                          /* ST-Stamm Anlegen     */
    iInit(pstrApp, "VS", pstrAppDru, NULL, awMasks,    /* Kunden-Stamm 1/2     */
      "110", "111", "112", "113", _N);
  ...
  case 120:                                          /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Lieferanten-Stamm 1/1*/
      "120", _N);

    M_InitMemo(&pstrMemoFile_g, "ST1200M",           /* Für Notizen je Daten-*/
      &pstrMemoTitel_g,"Allgemeine Lieferanten-Notiz"); /* satz > allgemein  */
    pstrAppTitel_g=
      strdup("Spezielle Lieferanten-Notiz");         /* Spezielle applikat   */
    break;                                           /* abh. Notiz/Record    */

  case 130:                                          /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Artikel-Stamm 1/3    */
      "130", _N);
  ...
  case 131:                                          /* ST-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* LK-Artikel-Stamm     */
      "134", _N);
  ...
  case 132:                                          /* ST-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Schnelländer.Artikel */
      "136", _N);
  ...
  case 140:                                          /*                      */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Personalstamm 1/1    */
      "170", _N);
  ...
  case 150:                                          /* ST-Stamm Anlegen     */
    pstr=(cKz_g=='L') ? stp("LKS") : stp("ST");      /*                      */
    iInit(pstrApp, pstr, pstrAppDru, NULL, awMasks,    /* Textbausteine 1/1    */
      "180", _N);
  ...
  case 220:                                          /* ST-Stamm Anlegen     */
    iInit(pstrApp, "ST", pstrAppDru, NULL, awMasks,    /* Lieferanten-Stamm    */
      "120", "121", _N);
  ...
  case 240:                                          /* KA-Stamm Anlegen     */
    iInit(pstrApp, "KA", pstrAppDru, NULL, awMasks,    /* Kassabuch 1/1        */
      "130", _N);

    M_InitMemo(&pstrMemoFile_g, "KA1300M",          /* Für Notizen je Daten-*/
      &pstrMemoTitel_g,"Allgemeine Kassabuch-Notiz " /* satz > allgemein     */
                       "für diesen Tag");            /*                      */
    pstrAppTitel_g=
      strdup("Spezielle Kassabuch-Notiz für diesen Tag"); /* Spezielle appli.*/

    boPrepare_g=EIN;				     /* Vorbereiten Eingabef.*/
    /* boDemoVersion_g=JA; */
    break;                                           /* abhäng. Notiz/Record */

  case 250:					     /* KA-Stamm Anlegen     */
    iInit(pstrApp, "KA", pstrAppDru, NULL, awMasks,    /* Kassabuch 1/1        */
      "150","151", _N);

    M_InitMemo(&pstrMemoFile_g, "KA1500M",	    /* Für Notizen je Daten-*/
      &pstrMemoTitel_g,"Allgemeine Kassabuch-Notiz " /* satz > allgemein     */
                       "für diesen Tag");            /*                      */
    pstrAppTitel_g=
      strdup("Spezielle Kassabuch-Notiz für diesen Tag"); /* Spezielle appli.*/
  ...
  case 430: /* aus AU1500.C ergänzen                 /* Erfassen Lagerbeweg. */
    iInit(pstrApp, "AU", pstrAppDru, NULL, awMasks,
      "250", _N);
    break;                                           /*                      */
