// (C) FiCore - Open Source Financial Core  Letztes Update am 14-Feb-1996 / 11:22:40 - Wed

/*╔═════════════════════════════════════════════════════════════════════════╗
  ║  Programme-Name: SY4100.C        Revision: 1.3         (C) 1989/1991    ║
  ║  Function      : Drucken FiCore-Systemdaten, Konstanten ...           ║
  ║                                                                         ║
  ║                                                                         ║
...
if(Maske(_MSK,"SY4020",_N))			     /* Bei Druck Menüzeilen,*/
...
if(Maske(_MSK,"SY4020",_N))			     /* Druck Menüeinträge   */
