...
&KOPF (0)
^┌┘GENERAL JOURNAL                                                                         Date: @@@@@@@@ - PAGE øøøø└┐ ~SM ~1._DATUM_AKT ~1._SEITE
│┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐│
...
&RUMPF (0)
øøøøøø  @@@@@@@@@@  ##.##.##  ¡@@@@@@@@  ##.###.###.##ø,øø ##.###.###.##ø,øø  ¡@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\
~0..SATZ_NR~0..BELEG_NR~0..BELEG_DAT~0°.KTO_ART~0..KONTO_NR~1._UMSATZ_SO~1._UMSATZ_HA~0..G_KTO_ART~0..GEGEN_KTO~0..BUCH_TEXT
&END

&RUMPF (1)
        Batch Transaction:    @@@@@@@@@  ##.###.###.##ø,øø ##.###.###.##ø,øø            @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\
...
&FUSS (0)
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
Journal Transactions on GL Accounts:     ##.###.###.##ø,øø ##.###.###.##ø,øø ~1._SUMME_SO~1._SUMME_HA
┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
