&TITEL       = "ST  Lieferanten Adressen n. Bez."
...
&KOPF (0)
^зыADRESSENLISTE LIEFERANTEN                           Datum: @@@@@@@@ - SEITE ⌡⌡⌡⌡ю© ~NO ~1._DATUM_AKT ~1._SEITE
...
Lieferanten-Kurzbezeichnung           Anrede
Lieferanten-Nummer                    Name
  StraАe                              Zusatz
  Land - PLZ/Ort                      Telefon                   Telefax
...
&RUMPF (0)
Ъ
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@            ~0.MATCH_CODE       ~0.ANREDE
@@@@@@@@@@@@@@@@@@@@                  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@            ~0.LIEFNR           ~0.NAME
  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@            ~0.STRASSE          ~0.ZUSATZ
  @@@ - @@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Tel:@@@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@@@@ ~0.LAND ~0.PLZ_ORT  ~0.TELEFON   ~0.TELEFAX
&END
