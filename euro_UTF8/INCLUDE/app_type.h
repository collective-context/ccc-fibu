...
// Funktion     : Die Datei enthält die Bezeichner für die, in allen
...
//------------------------------------------------------------------------------
   ...
   //------------------------------------------------------------------------------
   //              Konstanten für Speicherklassen u. ä.
   //------------------------------------------------------------------------------
   ...
   // #define FAR          far           // ==alt
   #define FAR             _far       // für C++ /ver.h

   #define CONST           const      // für C++
   #define CLASS           class      // für C++
   #define INLINE          inline     // für C++


   //------------------------------------------------------------------------------
   //         Datentypen der Toolbox, incl. Präfix vor Variablennamen
   //------------------------------------------------------------------------------
...
// typedef     LONG*               PLONG;    //   pl
   ...
   // size_t == »unsigned int« for a »count of bytes«
   ...
   #define REGISTER      register unsigned short   // für C++
