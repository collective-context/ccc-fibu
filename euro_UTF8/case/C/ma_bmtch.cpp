...
if (swZeile  < 3)
  swZeile=3;                                    /* Wert für Dialogfenster    */
  ...
  for(;;)                                           /* Eingaberoutine       */
  {
    ...
    switch(pEvent->wArt)                            /* Eventart auswerten   */
    {
      ...
      case EVENT_L_PRESS:                           /* MAUSEVENT auswerten  */
        ...
        if (pEvent->wZeile == wZeile_m+HOE-2)            /* Schaltflächen-Zeile  */
        {

          if (pEvent->wSpalte > wSpalte_m+2 &&            /* RETURN-Schaltfläche  */
	    ...
	    i_BKopiereTextBoxII (pTextBox_m, pTBox);
          ...
          else if (pEvent->wSpalte > wSpalte_m+16 &&      /* ESCAPE-Schaltfläche  */
          ...
          else if (pEvent->wSpalte > wSpalte_m+30 &&      /* HILFE-Schaltfläche   */
...
SWORD i_UpdateVerz(VOID)
{
  ...
  _i_FormatSchreiben (pTextBox_m);		 /* Notwendigkeit hier prüfen !!!!! */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  _i_FormatSchreiben ()                                Datum:  6.2.89   ║
  ╚════════════════════════════════════════════════════════════════════════╝*/
STATIC
VOID _i_FormatSchreiben (PTEXTBOXLIST pTB)
{
 ...
 /* Wie weiß ich hier i.a., was im Record zu stehen hat ????? */
