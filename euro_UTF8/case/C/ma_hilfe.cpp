...
IMPORT CHAR	acHlpKey_g[HLPKEY];   // Default-Schlüssel bei 2x[F1]
...
#define PFEILOBENAUS()	    Wi_Sza(wBre_m-6,1,'─',aCS_g[wCSInd_g].wCs_dlg)

#define PFEILUNTENAN()	    Wi_Sza(wBre_m-4,1,'',aCS_g[wCSInd_g].wCs_dlg_sp)
#define PFEILUNTENAUS()     Wi_Sza(wBre_m-4,1,'─',aCS_g[wCSInd_g].wCs_dlg)
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_HilfeTools()                 Datum: 17.08.89      ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
CHAR acHlpFile[HLPFL];	     /* Name der Hilfedatei / temporär		     */
CHAR acHlpKey[HLPKEY];	     /* Hilfstext-Schlüssel / temporär		     */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_KeineDateiDa()                Datum: 20.02.90     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_KeineInfosDa()                Datum: 20.02.90     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion wird                                 ║
  ║                                                                        ║
...
Ut_SchreibArray (apstrText, "    Für dieses Feld gibt es ",
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_KeinKeyDa()                   Datum: 20.02.90     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion wird                                 ║
  ║                                                                        ║
...
for(i=0, wZeile=2; i<TEXTZEILEN && *ppstrT != NULL;  /* Solange Zeilen da && */
  ...
  while(*pstr && wS<=wBre_m-4)			     /* um eines erhöhen und */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_ReadHelpRecord 	      Datum: 05.05.90	   ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter: 							   ║
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion gibt				   ║
  ║                                                                        ║
  ║  Rückgabewert:							   ║
  ║                                                                        ║
  ║  Benutzte globale                                                      ║
...
PSSTR	 pstrPos;
    ...
    Ut_Calloc(*ppstrTitel, TB_MAX, CHAR);
    sprintf ( *ppstrTitel, "Hilfe für %s", pstrPos);
	 ...
	 *ppstrTmp_m++ != NULL; 		     /* zeilen ermitteln     */
         wHilfsZeilen_m++);
    ppstrTmp_m = ppstrTxt_m;			     /* Zeiger zurücksetzen  */
