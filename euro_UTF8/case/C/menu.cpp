...
MGLOBAL SWORD  awFieldOffset_m[] =    /* Offset der Eingabefelder in der Menüdatei */
            { 6, 14, 40, 48, 61, 67, 78 };

MGLOBAL PITEM apHauptMenu_m[10];         /* Applikations-Hauptmenü */

MGLOBAL CHAR  strDateiName_m[TB_MAX] = "PW.BAT";
MGLOBAL FILE  *pFileHandle;

MGLOBAL EVENT Event;                                   /* für Rückgabe von                  */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║             AUSWERTEN DER PARAMETER-UEBERGABE AUS MSDOS                ║
  ║  <ProgrammName> [<Steurkennzeichen>] [<Menügruppe> <Folgesatz>]        ║
  ║                                                                        ║
  ║  z.B. PW.EXE MENÜ L000                                                 ║
  ╚════════════════════════════════════════════════════════════════════════╝*/
...
while (wSteuerKennzeichen_m >= 0)
{
   ...
   default:
         Ut_SchreibArray (apstrMessage, "Ungültige Parameterübergabe.",
...
/*Mn_Entfernen(HAUPTMENU);			     /* Menüzeile löschen    */
...
MS_g.wAktiv = JA;
    ...
    while (wEndlos_m)
    {
	 ...
	 Ut_SchreibArray (apstrMessage, "Das nächste Programm startet",
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    HauptMenuAufbauen              Datum: 28.07.89      ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║ MNU_Modul HAUPTMENU      MENÜ-ZUORDNUNG                                ║
  ╚════════════════════════════════════════════════════════════════════════╝*/
...
Mn_SetSchatten(HAUPTMENU, boMnSchatten_m);     /* Menüfenster mit      */
Mn_SetRahmenTyp(HAUPTMENU, wMnRahmen_m);       /* Rahmen für Menüfenster  */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    LoeschAltesMenu                Datum: 16.04.89      ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    SchreibBat()                   Datum: 30.01.89      ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        keine                                               ║
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion wird angesprungen,                   ║
  ║                                                                        ║
  ║  Benutzte globale                                                      ║
  ║  Variablen (R/W):                 (R)                                  ║
  ║                                                                        ║
...
SREGISTER i;
	 ...
	 if ( pFileHandle==NULL )
             ...
             sprintf (strError, "Datei »%s« konnte "
		     "nicht geöffnet werden", strDateiName_m);
         ...
         if ( fclose(pFileHandle) )         /* Dateien schließen         */
             {
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    BatFileHandler()               Datum:  2.8.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        keine                                               ║
  ║                                                                        ║
...
FILE *pFileHilf;
	 ...
	 pFileHandle=fopen(strDateiName_m, "w");   /* Datei öffnen	   */
	 if( pFileHandle==NULL )    /* Datei öffnen	    */
             {
             CHAR strError[TB_MAX];
	 ...
	 pFileHilf=fopen(strFile, "r"); 	     /* Datei öffnen	     */
	 if( pFileHilf==NULL )
             {
             CHAR strError[TB_MAX];

             sprintf (strError, "Datei »%s« konnte "
                     "nicht geöffnet werden", strFile);
         ...
         else if ( fclose(pFileHilf) )         /* Dateien schließen         */
             {
             printf ("\nDatei: %s konnte in MENU.EXE"
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    ende()                         Datum:  2.8.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        keine                                               ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    PasswordOK()                   Datum:  3.8.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        keine                                               ║
  ║                                                                        ║
...
strcpy (acTitel, "Prüfen der Zugriffsberechtigung");
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    Betriebssystem()               Datum:  2.8.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        keine                                               ║
  ║                                                                        ║
...
Ut_SchreibArray(apstrText,
  "Fehler beim »SET USER-Befehl« !!!                 ",
  "──────────────────────────────────────────────────",
  "Die DOS-Variable »USER« endet mit Leerzeichen:    ",
  "                                                  ", _N);
sprintf(apstrText[3], "USER = »%s«", pstrError);
