...
#define MARKIERUNG 240             /* Schwarze Schrift auf Weiß blinkend    */
...
#define       MAXINDEX 9                      /*/* höchster Index in         */
                                              /*/* awMonoAtt[]               */

SWORD awMonoAtt[] = { NORMAL,		       /*/* Array mit Attributen      */
                     HELL,                    /*/* für Monochrom-Modus       */
                     UNTER,
                     HELL_UNTER,
                     INVERS,
                     NORMAL | BLINKEN,
...
for(;;)
  ...
  if((pWkbWin_1=Wi_Einrichten(wSpalte_m,wZeile_m,
    ...
    printf("\nFenster konnte nicht "              /* Abbruch, wenn kein        */
      "eingrichtet werden.");                     /* pWkb zurück               */
    if (wVioMode_g == MONOCHROM)
       Wi_SetCursorTyp(11,12);                           /* Linien-Cursor         */
    else
       Wi_SetCursorTyp(6,7);
...
switch(pE->wTaste)                                      /* und auswerten     */
  ...
  case 'a':                                             /* Titelattribut     */
    if(wVideoMode == MONOCHROM) {                       /* verändern         */
      wTitelIndex=INVERS;
      wRahmenIndex=NORMAL;
      wInnenIndex=NORMAL;       }
    else                          {
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_HilfeEditieren()              Datum: 18.08.89     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_WriteHelpToDisk (PPSTR)       Datum: 30.08.89     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion wird                                 ║
  ║                                                                        ║
    ...
    if (pE->wArt == EVENT_TASTE)
      {
	   ...
	   PSSTR apstrText[25];
           ...
           Ut_SchreibArray (apstrText, "Es ist ein Fehler aufgetreten.",
                               ...
                               "gültigen Pfadnamen an oder unter-",
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_Read_Text                     Datum:  6.03.90     ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Beschreibung:     Diese Funktion wird                                 ║
  ║                                                                        ║
...
/*╔═════════════════════════════════════════════════════════════════════════╗
  ║ Camera ()                                                               ║
  ║ ─────────────────────────────────────────────────────────────────────── ║
  ║ Speichert das fertig editierte Bild unter der Extention .EGA o. .HER ab.║
  ╚═════════════════════════════════════════════════════════════════════════╝*/
MGLOBAL
