/*----------------------------------------------------------------------------
              ...
              Programm für die Definition eigener Druckertreiber
                      ...
                      für die Ausgabe von PCX-Graphiken
...
-----------------------------------------------------------------------------*/
  ...
  WORD     Resolution    = 0;       /* [EPSON,HP] Auflösung der Graphik           */

  CHAR     *PreYRes      = NULL;    /* [HP] Code VOR Y-Auflösung ( ESC & a )      */
  CHAR     *AftYRes      = NULL;    /* [HP] Code NACH Y-Auflösung ( H )           */
  ...
  VOID HeadLine ( VOID )
  {
       ...
       printf("--------------------------------------------------------------------------------");
       printf("                   Mück Softwareentwicklung C - Druckertoolbox\n\r" );
  ...
  VOID main ( VOID )
  {
       ...
       do
       {
            ...
            if ( PrinterType == MM_HP )
            {
                ...
                printf("\n\r\n\r");
                printf("Code VOR Auflösung in DPI (Hex): ");
                EnterHexCode( &PreDPIRes, 19 );

                printf("\n\r\n\r");
                printf("Code NACH Auflösung in DPI (Hex): ");
                EnterHexCode( &AftDPIRes, 19 );

                printf("\n\r\n\r");
                printf("Code für 'Graphikmodus an' (Hex): ");
                EnterHexCode( &GraphicOn, 19 );
            }
            else
            {
                printf("\n\r\n\r");
                printf("Code für Zeilenabstand 7/72 '' (Hex): ");
                EnterHexCode( &NoLineSpace, 19 );

                printf("\n\r\n\r");
                printf("Code für 'Neue Zeile' (Hex): ");
                ...
                printf("\n\r\n\r");
                printf("Code für normalen Zeilenabstand (Hex): ");
                EnterHexCode( &LineSpace, 19 );

                printf("\n\r\n\r");
                printf("Graphikauflösung in DPI: ");
                if ( Resolution > 0 )
                {
       ...
       do
       {
            ...
            printf("\n\r\n\r");
            printf("Code für Graphik-Ende (Hex): ");
