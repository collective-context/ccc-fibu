...
PWORD    pwAccessMode     Array, daแ den Zugriffsmode fr jede Datei speichert.
...
{
REGISTER i;
WORD wOwnerLength, wCreate=0;			       /* Lnge Besitzername  */
WORD wFileBufferLength;                                /* Lnge Filenamen     */
...
/*.ta B_Open(0)
ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
บ  B_Open()   ... ”ffnet eine Btrieve-Datei unter einer Dateinummer.           บ
ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ
...
ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
WORD   wFile	   Logische Dateinummer.
PSTR   apstrBlock[]   Zeiger-Array auf Positionsbl”cke.
PSTR   apstrRecord[]      Array von Zeigern auf String je Datensatz.
WORD   awRecordLength[]   Array, daแ die Datenstatzlnge je Datei enthlt.
PSTR   apstrFileName[]    Array aller Datei-Namen.
WORD   awAccessMode[]     Array, daแ den Zugriffsmode fr jede Datei speichert.
...
Die Dateien mssen zuvor irgendwann mit der ฏB_Create()ฎ Funktion erzeugt und
damit vorhanden sein. Wird versucht eine Datei zu er”ffnen, welche nicht
vorhanden ist, so wird der Fehlerstatus 12 zurckgegeben.
...
{
REGISTER i;
WORD wOwnerLength;                                     /* Lnge Besitzername  */
WORD wFileBufferLength;                                /* Lnge Filenamen     */
WORD wStatus = 0;
BOOL boSypara;
...
if (apstrOwner[wFile])				/* Falls Besitzername  */
   wOwnerLength = strlen(apstrOwner[wFile]) +1; /* da, Lnge speichern */
else                                                   /* sonst ist die Be-   */
   wOwnerLength = 0;                                   /* sitzernamenlnge 0  */
