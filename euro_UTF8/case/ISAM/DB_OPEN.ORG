...
STATIC WORD i_AnalyseKeys (FILEINFO, PFSPEC, WORD, PSTR, WORD);
STATIC WORD i_ExchangeKeyInfo (FILEINFO, WORD, WORD);
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
GLOBAL
WORD Db_Open (WORD   wFile,	       PPSTR ppstrBlock,
	      ...
	      PWORD  pwMaxKey,	       FILEINFO aFiles[],
	      PSTR   pF, WORD wL)
{
REGISTER i;
...
/*╔═════════════════════════════════════════════════════════════════════════╗
  ...
  ╚═════════════════════════════════════════════════════════════════════════╝*/
STATIC
WORD i_AnalyseKeys(FILEINFO FileInfo, PFSPEC apfsFile,
...
/*╔═════════════════════════════════════════════════════════════════════════╗
  ...
  ╚═════════════════════════════════════════════════════════════════════════╝*/
STATIC
WORD i_ExchangeKeyInfo (FILEINFO File, WORD wDest, WORD wSrc)
{
