...
────────────────────────────────────────────────────────────────────────────────
#include <eur_dlg.h>
WORD Dl_Laden(pstrDateiname);


Parameter:
────────────────────────────────────────────────────────────────────────────────
PSTR   pstrDateiname   Eingang: Zeiger auf String, der das Startlaufwerk und
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
STATIC	PSTR pstrDTitel_m    = "Datei laden";
STATIC	PSTR pstrD_m	     = "Dateiname:";
STATIC	PSTR pstrVerz_m      = "Dateien in:";

STATIC	PSTR pstrUngueltigPfad_m = "/[]{}|<>+=,;\"";
STATIC	PSTR pstrUngueltigDat_m  = "/[]{}|<>+=,;\" :?*\.";
...
STATIC	WORD wStartLW_m;			    /* Startlaufwerk	    */
STATIC	WORD wWorkLW_m; 			    /* Arbeitslaufwerk	    */
...
WORD Dl_Laden(PSTR pstrDateiName)
{
  ...
  PSTR  pstrTmp;                                    /* mit dem Quick C-Schal-*/
                                                    /* ter -qc compileren:   */
  ...
  swMaxDateien = MAXDATEIEN;                        /* größtmögliche RAM-   */
  while( (pacStart_m =                              /* Kapazität ausnutzen  */
                    Ut_Malloc( sizeof(*pacStart_m) * swMaxDateien) ) == NULL )
  {
     swMaxDateien -= 20;
     if (swMaxDateien < 0)
        return (DLG_ERROR);
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ║                    SWORD swMaxDateien   maximal einlesbare Dateien     ║
  ║                                                                        ║
...
BOOL i_BewegeBalken( SWORD swRichtung )
{
  ...
  if (swRichtung > 0)                               /* Bewegung nach unten  */
  {
    ...
    swRest = pacEnde_m - pacAkt_m                   /* Einträge außerhalb   */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        WORD  wBuchstabe   Suchmaske                        ║
  ║                                                                        ║
...
BOOL i_Direkt( WORD wBuchstabe)
{
  ...
  wBuchstabe = Ut_Klein(wBuchstabe);                /* in Kleinbuchstaben   */
                                                    /* umwandeln            */
