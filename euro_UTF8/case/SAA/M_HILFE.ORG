...
IMPORT WORD	wLoopF1_g;		    /* 1 X [F1]-Taste	    */
...
STATIC BOOL cdecl i_KeineDateiDa	 (PSTR, PSTR);
STATIC BOOL cdecl i_KeinKeyDa		 (VOID);
STATIC VOID cdecl i_HilfeSchreibeText	 (PPSTR);
STATIC WORD cdecl i_ReadHelpRecord	 (PTEXTBOX, PSTR, PSTR, PPSTR, PPWKB);
  ...
  switch(pEvent->wArt)
	...
	if(pEvent->wSpalte == (wSpa_m+51))
	  ...
	  i_EineZeileRunter(ppstrTxt_m);
		...
		pEvent->wSpalte < wSpa_m+3+strlen(pstrEsc_g))
	       {
	       Wi_Entfernen(pWkbDialog);
	       Ut_Free(pstrTitel_g);
	       Ut_LoeschArray(apstrText_m);
	       return;
		     ...
		     pEvent->wSpalte < wSpa_m+17+strlen(pstrF1_g))
		    {
                    i_Dl_HilfeFuerHilfe();
		    }
             }
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ║                                                                        ║
  ╚════════════════════════════════════════════════════════════════════════╝*/
BOOL i_KeineDateiDa(PSTR pstrFileName, PSTR pstrFileBlock)
{
EVENT event;
PEVENT pE = &event;
PWKB pWkbDialog;
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
STATIC
WORD i_ReadHelpRecord(PTEXTBOX pT, PSTR pstrHelpFile, PSTR pstrHelpKey,
		    PPSTR ppstrTitel, PPWKB ppWkbDialog)
{
REGISTER i;
WORD	wBufLength, wDummy;
...
PSTR	pstrPos;
    ...
    stradd (pstrHelpFile, strHlp_g, pT->acHelpFile, ".", strExt_g, NULL);
