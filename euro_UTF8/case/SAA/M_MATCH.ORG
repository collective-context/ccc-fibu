...
Rückgabewert:
────────────────────────────────────────────────────────────────────────────────
WORD    Information, welche Schaltfläche der Anwender beim Verlassen der
...
STATIC	WORD wVFH_m;	      /* Verzeichnisfeld-Höhe			     */

STATIC	WORD wRecKeyOfs_m;    /* Offset des Primärschlüssels in der Stammdatei */
...
STATIC	WORD wFokus_m;				    /* Fokus für RETURN     */
...
GLOBAL	BOOL boMaskAkt_g=NEIN;			     /* Für Match_Check_OK() */
...
{
REGISTER i;
SWORD swMaxEintraege;                             /* max. Verz.-Einträge  */
WORD  wMausStatus;
WORD  wRetStatus;
PSTR pstrHilf;
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        PSTR  pstrMaske      gewünschte Suchmaske           ║
  ║                    SWORD swMaxEintraege maximal einlesbare Einträge    ║
  ║                                                                        ║
...
wAktZeile_m = 0;
  ...
  i_RecordToBox(pTextBox);		 /* Notwendigkeit hier prüfen !!!!! */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:        SWORD swRichtung    bestimmt Bewegung               ║
  ║                                                                        ║
  ║                                           > 0: nach oben               ║
  ║                                           = 0: keine Bewegung          ║
  ║                                           < 0: nach unten              ║
...
BOOL i_BewegeBalken( SWORD swRichtung )
{
  ...
  if (swRichtung > 0)                               /* Bewegung nach unten  */
  {
    ...
    swRest = ppstrEnde_m - ppstrAkt_m               /* Einträge außerhalb   */
    ...
    {
      if (swRest >= swRichtung)                     /* genug Einträge zum   */
      {                                             /* scrollen ?           */
        ppstrAkt_m += swRichtung;                   /* Zeiger aktualisieren */
        ppstrAktKey_m += swRichtung;
        ppstrAktEdit_m += swRichtung;
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ║                    PSTR  pstrKey             Primärschlüssel für       ║
  ║                                              Datensatz                 ║
  ║                    PTEXTBOX apTextBox[][99]  Informationen über die    ║
  ║                                              aufrufende Applikation    ║
  ║                    WORD awAddFields[][20]    zusätzlich anzuzeigende   ║
  ║                                              Felder                    ║
  ║                                                                        ║
