...
STATIC	WORD wSdf_m = 6;    /* erste SpalteDialogFelder in der Dialogbox    */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
GLOBAL
SWORD M_MakeChoice (PSWORD pswSelect, PPSTR ppstrTxt, PSTR pstrTitel,
                    WORD wSpa, WORD wZei)
{
    REGISTER i;
    ...
    wBre_m = wMaxln_m + 14;              /* rechts und links 7 Zeichen Rand */
    ...
    switch(wResult)
    {
        case DLG_ESC:                               /* abgebrochen          */
            ...
            *pswSelect = -1;                        /* Dialog-Abruch liefert*/
