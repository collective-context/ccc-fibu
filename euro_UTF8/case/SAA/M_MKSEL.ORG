...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
IMPORT MENU      aMenus_g[];                /* Array mit Menüs              */

IMPORT COLORSET  aCS_g[];                   /* Farbpalette und Index auf    */
IMPORT WORD      wCSInd_g;                  /* Palette                      */

IMPORT PSTR      pstrReturn_g;              /* Texte der Schaltflächen      */
...
STATIC	WORD wSpa_m;			     /* erste Spalte der Dialog-Box */
STATIC	WORD wZei_m;			     /* erste Zeile  der Dialog-Box */

STATIC	WORD wSdf1_m = 6;   /* erste SpalteDialogFelder in der Dialogbox    */
STATIC	WORD wSdf2_m;
STATIC	WORD wZdf_m = 3;    /* erste ZeileDialogFelder in der Dialogbox     */
STATIC	WORD wMaxdf_m;	    /* maximaleDialogFelder in der Dialogbox	    */
STATIC	WORD wMaxln_m;	    /* maximale DialogfeldLäNge in der Dialogbox    */

STATIC	WORD wBre_m;	    /* Breite der Dialog-Box			    */
STATIC	WORD wHoe_m;	    /* Hoehe  der Dialog-Box			    */

STATIC	PSTR pstrTitel_m;			    /* Titelzeile	    */

STATIC	PSTR apstrText_m[25];			    /* Text der Auswahl-    */
                                                    /* liste                */

STATIC	WORD awSelected_m[25];			    /* Werte der Auswahl-   */
                                                    /* liste                */
...
STATIC	VOID cdecl i_ZeigeBalken    (PSTR[]);
STATIC	WORD cdecl i_BalkenEvent    (VOID);
STATIC	VOID cdecl i_SetMarker	    (WORD, WORD);
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
GLOBAL
SWORD M_MakeSelect (PPSTR ppstrTxt, PWORD pwWert,
                    PSTR pstrTitel, WORD wSpa, WORD wZei)
{
    REGISTER i;
    PWKB    pWkbDialog;                             /* Zg. Window-Struktur  */
    WORD    wResult;                                /* für Rückgabewert     */
    ...
    for (i=0; ppstrTxt[i]; i++)
      {
       ...
       if (wMaxln_m < strlen (apstrText_m[i]) )
    ...
    if (wBre_m - 4 < strlen (pstrTitel_m))
      {
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ...
  ╚════════════════════════════════════════════════════════════════════════╝*/
STATIC
VOID i_SetMarker (WORD wWo, WORD wWie)
{
