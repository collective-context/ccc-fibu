// (C) FiCore - Open Source Financial Core  Letztes Update am 02-Mar-1996 / 16:05:44 - Sat
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:  Block_Key_Code_Evaluation        Datum: 29.11.89      ║
  ║────────────────────────────────────────────────────────────────────────║
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*if(pEvent_g->wKbflags & (LEFT_SHIFT|RIGHT_SHIFT) || /* Shift-Taste gedrückt */
