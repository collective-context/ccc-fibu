// (C) FiCore - Open Source Financial Core  Letztes Update am 02-Mar-1996 / 16:05:46 - Sat
...
#define POS_LENGTH 28                /* Länge der Einträge im Positionsrecord */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_BlockMaskAufbau               Datum: 2.1.90       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_ExchangeBlock                Datum:16.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
		      ...
		      PSSTR apstrPosition[], SWORD awPosLen[])
{
 ...
 if (!pBlInit)
   {
    system ("cls");                             /* nur temporär, zu ersetzen */
 ...
 /* Die folgende for-Schleife ist nur für Masken mit nur einer Spalte korrekt,*/
 /* da sie nur die Offsetwerte der aktuellen Blockspalte korrigiert.          */
 /* Ebenso wie i_AdjustRecLength() muß sie noch korrigiert werden !!!!        */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_InsertBlockX                 Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_DeleteAllBlocks              Datum:20.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_DeleteBlockY                 Datum:19.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_DelNotVisualBlockY           Datum:19.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_DeleteBlockY                 Datum:19.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
if(!pLine1)
  {
  system("cls");			       /* nur temporär, zu ersetzen */
  printf("\n\n\nUngültige Blockzeilennummer %d in DeleteBlock\n", wBlockY);
  E(); exit (-1);				       /* ev. weitere Errorinfo */
  }
...
if(!pColumn1)
  {
  system ("cls");			      /* nur temporär, zu ersetzen */
  printf ("\n\n\nUngültige Blockspaltennummer %d in DeleteBlock\n", wBlockX);
  E(); exit (-1);				       /* ev. weitere Errorinfo */
  }
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_InsertBlockY                 Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_InsNotVisualBlockY           Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_InsertBlockY                     Datum: 5.1.1990    ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
		     ...
		     SWORD awPosLen[], PSSTR pstrMode, SWORD wMode)
{
 ...
 if(!pLine1)	  /* Ungültige Blockzeilennummer %d in InsertBlock */
 ...
 if (!pColumn1)    /* Ungültige Blockspaltennummer %d in InsertBlock */
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_InsertFixBlock               Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
  ║                                                                        ║
  ║  Beschreibung:     Die Funktion darf nur im Tool, und zwar in          ║
  ║                    der Funktion M_BInit aufgerufen werden.             ║
  ║                    Die Funktion kopiert den fixen Teil einer           ║
  ║                    Maske aus der initialisierten Liste in              ║
  ║                    den aktuellen Teil der Blockliste.                  ║
  ║                    Ein nochmaliger Aufruf dieser Funktion              ║
  ║                    (außerhalb von M_BInit) würde zwangsläufig          ║
  ║                    dazu führen, daß reservierter Speicher für          ║
  ║                    immer verlorenginge, da die Funktion keine          ║
  ║                    Test durchführt, ob Sie schon einmal                ║
  ║                    aufgerufen worden ist.                              ║
  ║                                                                        ║
  ║  Rückgabewert:     Rückgabewert ist eine Fehlerinformation.            ║
...
if(!pBlInit)
  Dl_Abbruch("Blockname", _L, _F, str("»%s«",pstrBlockName));
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_SetVisualBlock()             Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
VOID M_SetVisualBlock (PMASKS pMask, SWORD wBlockX, SWORD wBlockY)
{
 ...
 if (!pColumn)
   {
    system ("cls");                             /* nur temporär, zu ersetzen */
    printf ("\n\n\nUngültige Blockspaltennummer %d in InsertBlock\n", wBlockX);
    E(); exit (-1);					 /* ev. weitere Errorinfo */
   }
 ...
 if (!pLine)
   {
    system ("cls");                             /* nur temporär, zu ersetzen */
    printf ("\n\n\nUngültige Blockzeilennummer %d in InsertBlock\n", wBlockY);
    E(); exit (-1);					 /* ev. weitere Errorinfo */
   }
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_BlockOutput                  Datum: 4.12.89       ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:   i_AdjustRecLength                    Datum: 4.12.89    ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Bemerkung:                                                              ║
  ║                                                                          ║
  ║        Die Funktion i_AdjustRecLength behandelt zur Zeit (22.12.1989)    ║
  ║        nur Blockmasken, die nur eine Spalte enthalten. Tabellenartige    ║
  ║        Masken werden erst in einer späteren Version unterstützt werden.  ║
  ║                                                                          ║
  ╚══════════════════════════════════════════════════════════════════════════╝*/
STATIC
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_KopiereBlock                     Datum: 5.1.1990    ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_KopiereInitTBL                   Datum: 18.1.1990   ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_ManageTBL                        Datum: 5.1.1990    ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
VOID i_ManageTBL (PMASKS pMask)
{
 ...
 /* In Version 1.00 werden erst Masken mit einer Spalte unterstützt,          */
 /* deshalb werden hier nur die Zeilen der ersten Spalte behandelt.           */
 /* Für spätere Versionen muß diese Routine noch erweitert werden.            */
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_InsertTBL                         Datum: 5.1.1990   ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_ResolveSequenz               Datum: 27.11.1989      ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_SetLastVisualColumn          Datum: 18.12.1989      ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
...
/*╔══════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_SetLastVisualLine            Datum: 18.12.1989      ║
  Ã──────────────────────────────────────────────────────────────────────────Â
  ║                                                                          ║
  ║  Beschreibung:     Diese Funktion                                        ║
  ║                                                                          ║
