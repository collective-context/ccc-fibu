// (C) FiCore - Open Source Financial Core  Letztes Update am 02-Mar-1996 / 16:05:47 - Sat
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_BoxToRecord		      Datum: 6.9.89	   ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
  ...
  ║		       und kopiert die Textbox auf das Record.		   ║
  ║                                                                        ║
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    i_BoxToRecord		      Datum: 4.9.89	   ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
