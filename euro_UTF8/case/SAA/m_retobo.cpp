...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    M_RecordToBox()		      Datum: 4.9.89	   ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
...
switch(pT->bTyp)
  ...
  case 4:
    ...
    if(pT->pSelect)
      {SWORD wPre=(*pT->pstrChoiceTitel=='─') ? 1 : 0;
...
/*╔════════════════════════════════════════════════════════════════════════╗
  ║  Funktionsname:    Dl_StringToBox() 	      Datum: 4.9.89	   ║
  Ã────────────────────────────────────────────────────────────────────────Â
  ║                                                                        ║
  ║  Parameter:                                                            ║
  ║                                                                        ║
  ║                                                                        ║
  ║  Beschreibung:     Die Funktion formatiert den übergebenen String	   ║
  ║		       und speichert ihn in der Textbox.		   ║
  ║                                                                        ║
  ║                                                                        ║
  ║  Rückgabewert:     Die Funktion hat keinen Rückgabewert.               ║
  ║                                                                        ║
