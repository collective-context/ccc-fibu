...
Attribut wird nicht verändert. Der Cursor muß sich im aktiven Window befinden.     ║
...
der Cursor an den Anfang der nächsten Zeile gesetzt. In dem Sonderfall, daß
das letzte Zeichen der letzten Zeile bearbeitet wurde, wird der Fensterinhalt
eine Zeile nach oben gescrollt. Der Cursor wird dann in Spalte »0« der neuen
Zeile gesetzt.
