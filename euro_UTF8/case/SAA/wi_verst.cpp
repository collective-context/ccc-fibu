...
Beschreibung:
────────────────────────────────────────────────────────────────────────────────
Die Funktion nimmt das gewünschte Window vom Bildschirm, sichert es in dem
...
Die Anzahl der versteckten Windows ist nur durch den zur Verfügung stehenden
Speicherplatz beschränkt.

Hinwies:
────────────────────────────────────────────────────────────────────────────────
Bitte beachten Sie, daß das Verstecken eines verdeckten Windows, immer ein
kurzes Flackern mit sich bringt, da alle Fenster, die das zu versteckende
Fenster überlagern, zuerst abräumt und nach dem Verstecken wieder aufgelgt
werden müssen. Sie können diesen Effekt in dem Demoporgramm »Wi_Dmp.c« be-
obachten. Um das Bildschirmflackern zu vermeiden, empfehlen wir Ihnen, möglichst
...
SWORD Wi_Verstecken (PWKB pWkb)
{
    ...
    {                                               /* auf WKB zeigt        */
        ...
        return (ERROR);                             /* zurück an aufr. Fkt. */
    }
